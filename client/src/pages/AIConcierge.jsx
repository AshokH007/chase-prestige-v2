                    ...
                    <div className="max-w-[820px] mx-auto px-6 lg:px-0">
                        ...
                        <div className="mt-8 flex items-center justify-center gap-6 opacity-30 grayscale hover:grayscale-0 transition-all duration-700">
                            <div className="flex items-center gap-2">
                                <Shield size={10} />
                                <span className="text-[9px] font-black uppercase tracking-[0.2em]">Tier V Institutional Sync</span>
                            </div>
                            <div className="w-1 h-1 rounded-full bg-slate-300"></div>
                            <div className="flex items-center gap-2">
                                <span className="text-[9px] font-black uppercase tracking-[0.2em]">Chase Prestige Global • FDIC</span>
                            </div>
                        </div>
                    </div>
                </div>
